...
public class UseOfArrayList02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n--------------------------------");
		// addAll(int index, Collection c) --> Inserts all of the elements in the specified collection into thislist at the specified position (optional operation). Shifts theelement currently at that position (if any) and any subsequentelements to the right (increases their indices). 
